  ...
  return (
    <div className="history-map-shell">
      ...
      <div className="map-readout">
        <strong>{selectedEntry?.robotId ?? 'No history selected'}</strong>
        <span>{selectedEntry ? `${selectedEntry.distanceMeters} m route` : 'Select a run to inspect route data'}</span>
        <small>Read-only historical LineString and event point layers.</small>
      </div>
    </div>
  );
}
